...
<head>
	@php
		$register = \App\Models\Register::where('id',20)->first();
	...
	<div class="container">
		<div class="content">
			...
			<div class="body">
				...
				<div class="content">
					Hi ${admin}, formulir ${form_name} mendapatkan satu partisipan baru. Cek selengkapnya untuk detail lebih lanjut
                    <table>
                        <tr>
                            <td>Email</td>
                            <td>: {{ $register->thisRegistant->email }}</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>: {{ $register->updated_at->format('d F Y') }}</td>
                        </tr>
                    </table>
				</div>
				<div class="button">
                    <table>
                        <tr>
                            <td>
                                <a href="{{ route('admin.register.detail',[$register->id]) }}" class="btn">Lihat Formulir</a>
                            </td>
                        </tr>
                    </table>
				</div>
