								...
								@foreach($per->getVerifikasi as $ver)
									<tr>
										...
										<td class="text-center">
											{!! ($ver->ada_tidak) ? "<a target='_blank' href='".url('permohonan/download/file-persyaratan',[base64_encode($ver->file)])."'><i class='ti-link'></i></a>" : "-" !!}
										</td>
									</tr>
								@endforeach
								</tbody>
							</table>
							<div class="divider text-primary">CATATAN PERMOHONAN PENCABUTAN</div>						
