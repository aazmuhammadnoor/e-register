                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group{{ $errors->has('npwp') ? ' has-error' : '' }}">
                                        ...
                                        <input id="npwp" type="text" class="form-control" name="npwp" value="{{ $reklame != null ? $reklame->npwp : '' }}" required>
                                        @if ($errors->has('npwp'))
                                            <span class="help-block">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group{{ $errors->has('npwp_d') ? ' has-error' : '' }}">
                                        ...
                                        <input id="npwp_d" type="text" class="form-control" name="npwp_d" value="{{ $reklame != null ? $reklame->npwp_d : '' }}" required>
                                        @if ($errors->has('npwp_d'))
                                            <span class="help-block">
                                                <strong>{{ $errors->first('npwp_d') }}</strong>
                                            </span>
                                        @endif
                                    </div>
                                </div>
