                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group{{ $errors->has('nama_pada_sertifikat') ? ' has-error' : '' }}">
                                        ...
                                        <input id="nama_pada_sertifikat" type="text" class="form-control" name="nama_pada_sertifikat" value="{{ $pembangunan != null ? $pembangunan->nama_pada_sertifikat : '' }}" required>
                                        @if ($errors->has('nama_pada_sertifikat'))
                                            <span class="help-block">
                                                <strong>{{ $errors->first('nama_pada_sertifikat') }}</strong>
                                            </span>
                                        @endif
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group{{ $errors->has('tanggal_sertifikat') ? ' has-error' : '' }}">
                                        ...
                                        <input type="text" class="form-control" data-provide="datepicker" data-date-today-highlight="true" data-date-format="dd-mm-yyyy" name="tanggal_sertifikat" value="{{ $pembangunan != null ? $pembangunan->tanggal_sertifikat ? date_id_number($pembangunan->tanggal_sertifikat) : '' : '' }}" required>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group{{ $errors->has('tanggal_akte_jual_beli') ? ' has-error' : '' }}">
                                        ...
                                        <input type="text" class="form-control" data-provide="datepicker" data-date-today-highlight="true" data-date-format="dd-mm-yyyy" name="tanggal_akte_jual_beli" value="{{ $pembangunan != null ? $pembangunan->tanggal_akte_jual_beli ? date_id_number($pembangunan->tanggal_akte_jual_beli) : '' : '' }}" required>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group{{ $errors->has('nomor_gs') ? ' has-error' : '' }}">
                                        ...
                                        <input id="nomor_gs" type="text" class="form-control" name="nomor_gs" value="{{ $pembangunan != null ? $pembangunan->nomor_gs : '' }}" required>
                                        @if ($errors->has('nomor_gs'))
                                            <span class="help-block">
                                                <strong>{{ $errors->first('nomor_gs') }}</strong>
                                            </span>
                                        @endif
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group{{ $errors->has('nama_ahli_waris') ? ' has-error' : '' }}">
                                        ...
                                        <input id="tahun_gs" type="text" class="form-control" name="tahun_gs" value="{{ $pembangunan != null ? $pembangunan->tahun_gs : '' }}" required>
                                        @if ($errors->has('tahun_gs'))
                                            <span class="help-block">
                                                <strong>{{ $errors->first('tahun_gs') }}</strong>
                                            </span>
                                        @endif
                                    </div>
                                </div>
