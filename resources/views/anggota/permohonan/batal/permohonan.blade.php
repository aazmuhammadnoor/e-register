                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="keterangan" class="control-label">Keterangan Dibatalkan</label>
                                <textarea placeholder="Keternagan Dibatalkan" class="form-control" rows=5 name="keterangan"></textarea>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                            <button class="btn btn-label btn-danger" id="btn-submit" type="submit"><label><i class="ti-close"></i></label> Batalkan</button>
                        </div>
                    </div>
                </form>
                        ...
                        <div class='col-md-12'>
                            <table class="table">
                                ...
                                <tr>
                                    ...
                                    <td>:
                                        @if($per->posisi != 'arsip' && $per->posisi != 'tolak' && $per->posisi != 'selesai')
