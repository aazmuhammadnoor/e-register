        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="card card-body" data-provide="wizard">
                    ...
                    <div class='divider'>YANG HARUS DIBAYARKAN</div>
                    @include('admin.proses.partial.spm')
                    <hr/>
                    <div class='row'>
                      <div class="col-3">
                        <a target="_blank" href="{{ url('permohonan/pembayaran/download-slip',[$per->id]) }}" class="btn btn-sm btn-primary">Download Slip Pembayaran</a>
                      </div>
                    </div>
                    <div class='row'>
                        <div class='col-md-12'>
                ...
                <footer class='card-footer text-left'>
                    <button type='submit' class='btn btn-label btn-primary'><label><i class="ti-check"></i></label> Proses</button>
