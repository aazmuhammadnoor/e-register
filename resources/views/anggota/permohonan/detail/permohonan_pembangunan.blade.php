                ...
                <div class="card card-body" data-provide="wizard">
                    ...
                    <div class='row'>
                        ...
                        <div class="col-md-12">
                            <table class="table">
                                <tr>
                                    <td width="30%">JENIS SERTIFIKAT</td>
                                ...
                                <tr>
                                    ...
                                    <td>: {{ $per->getPembangunan->tanggal_sertifikat }}</td>
                                </tr>
                                <tr>
                                    <td>LUAS TANAH</td>
                                ...
                                <tr>
                                    ...
                                    <td>: {{ $per->getPembangunan->nomor_akta_jual_beli }}</td>
                                </tr>
                                <tr>
                                    <td>TANGGAL AKTA JUAL BELI</td>
                                    <td>: {{ $per->getPembangunan->tanggal_akta_jual_beli }}</td>
                                </tr>
                                <tr>
                                    <td>NAMA NOTARIS</td>
