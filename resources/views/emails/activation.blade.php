...
<body>
    <section class="container">
    	...
    	<div class="row p-4">
    		...
    		<div class="col-12 text-center">
    			<p>Terimakasih, Anda telah mendaftarkan diri ke Perizinan Online DPMPTSP Kota Palembang melalui email {{ $pendaftar->email }}, klik link berikut ini untuk aktivasi akun Anda:</p>
    		</div>
    		<div class="col-12 text-center">
    			<a href="{{ url('anggota/aktivasi', $pendaftar->kode_aktivasi) }}" class="btn">Aktivasi</a>
    		</div>
    	</div>
      <div class="row p-4">
