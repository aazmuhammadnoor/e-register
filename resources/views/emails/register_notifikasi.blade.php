    ...
    <div class="container">
        <div class="content">
            ...
            <div class="body">
                ...
                <div class="content">
                    Hai, Status registrasi anda saat ini <strong class="text-uppercase">{{ $register->status }}</strong>
                    @if($register->keterangan)
                        <p>Keterangan : <br> {{ $register->keterangan }}</p>
                    @endif
                    Untuk lebih lanjut klik link dibawah ini. Terimakasih.
                    <br><i>Pesan ini dibuat otomatis oleh sistem</i>
                </div>
                <div class="button">
                    <table>
                        <tr>
