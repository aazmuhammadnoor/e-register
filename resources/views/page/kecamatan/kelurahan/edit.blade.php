        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    {{ Form::open(['url' => 'referensi/kelurahan/'.$kec->id.'/'.$kel->id.'/edit']) }}
                    ...
                    <div class="card-body form-type-fill">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                {!! Form::text('name',$kel->name,['class'=>'form-control form-control-sm']) !!}
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-3 col-form-label">Titik Koordinat</label>
                            <div class="col-sm-3">
                                {!! Form::text('latitude',$kel->latitude,['class'=>'form-control form-control-sm','placeholder'=>'latitude']) !!}
                            </div>
                            <div class="col-sm-3">
                                {!! Form::text('longitude',$kel->longitude,['class'=>'form-control form-control-sm','placeholder'=>'Longitude']) !!}
                            </div>
                        </div>                                                
                        <div class="form-group row">
                            <label class="col-sm-3 col-form-label">Polygon</label>
                            <div class="col-sm-9">
                                <textarea class="form-control" placeholder="Polygon" name='polygon'>{{ $kel->polygon }}</textarea>
                            </div>
                        </div>
                    </div>
