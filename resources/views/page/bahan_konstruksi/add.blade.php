    	...
    	<div class="row">
    		<div class="col-12">
    			<div class="card">
                    ...
                    {{ Form::open(['url' => 'referensi/bahan-konstruksi/add']) }}
    				<div class="card-body form-type-fill">
                        ...
                        <div class="form-group row">
                            <label class="col-sm-2 col-form-label require">Jenis Konstruksi</label>
                            <div class="col-sm-4">
                    ...
                    <footer class="card-footer text-left">
                        ...
                        <a href="{{ url('referensi/bahan-konstruksi') }}" class="btn btn-label btn-danger btn-sm"><label><i class="ti-close"></i></label> Batal</a>
                    </footer>
                    {{ Form::close() }}
    			</div>
    		</div>
