<div class="flexbox mb-20">
	...
	<div class="btn-toolbar">
		<div class="btn-group btn-group-sm">
			<button class="btn" title="" data-provide="tooltip"  data-url="{{ url('perizinan/pendaftaran/filter') }}" data-type="right" data-original-title="Filter" data-title="Filter Data Pendaftaran" id="modal-filter"><i class="ti-filter"></i> Filter</button>
			<button onclick="javascript:window.location.href='{{ url('perizinan/pendaftaran/list') }}'" class="btn" title="" data-provide="tooltip" data-original-title="Refresh"><i class="ion-refresh"></i> Refrersh</button>
			@can('pendaftaran-izin-baru')
			<button onClick="javascript:window.location.href='{{ url('perizinan/pendaftaran/') }}'" class="btn" title="" data-provide="tooltip" data-original-title="Add new"><i class="ion-plus-round"></i> Tambah</button>
			@if(session()->has('sessi_izin'))
				<button class="btn" id="kirim_ke_bidang_teknis" data-provide="tooltip" data-original-title="Kirim Ke Bidang Teknis"><i class="ti-share"></i> Submit</button>
			@endif
			@endcan
		</div>
	</div>
