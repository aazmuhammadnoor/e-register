    	...
    	<div class="row">
    		<div class="col-12">
    			<div class="card">
                    ...
                    {{ Form::open(['url' => 'referensi/persyaratan/add']) }}
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    {!! Form::textarea('name',old('name'),['class'=>'form-control form-control-sm']) !!}
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <div class="custom-controls-stacked">
                                        <label class="custom-control custom-radio">
                                            {!! Form::radio('jenis',1,true,['class'=>'custom-control-input']) !!}
                                            <span class="custom-control-indicator"></span>
                                            <span class="custom-control-description"> Persyaratan Administrasi</span>
                                        </label>
                                        <label class="custom-control custom-radio">
                                            {!! Form::radio('jenis',0,null,['class'=>'custom-control-input']) !!}
                                            <span class="custom-control-indicator"></span>
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <div class="custom-controls-stacked">
                                        <label class="custom-control custom-radio">
                                            {!! Form::radio('aktif',1,true,['class'=>'custom-control-input']) !!}
                                            <span class="custom-control-indicator"></span>
                                            <span class="custom-control-description"> Ya, Tampilkan sebagai persyaratan aktif</span>
                                        </label>
                                        <label class="custom-control custom-radio">
                                            {!! Form::radio('aktif',0,null,['class'=>'custom-control-input']) !!}
                                            <span class="custom-control-indicator"></span>
