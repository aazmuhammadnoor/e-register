    		...
    		<div class="col-12">
    			<div class="card">
    				...
    				<div class="card-body">
    					...
    					@include('page.verifikasi.toolbar')
    					@if($rs->count() > 0)
    								...
    								<tr>
                                        ...
                                        <td class="text-center table-actions">
                                            ...
                                            @can('verifikasi-permohonan')
                                                @if(in_array($row->getWorkflowStatus->getSubtask()->latest()->first()->sub_task, ['verifikasi.permohonan']))
                                                <a href="{{ url('verifikasi/view',[$row->id]) }}" class="table-action hover-primary"
                                                    data-provide="tooltip" data-original-title="Verifikasi Permohonan">
