    	...
    	<div class="row">
    		<div class="col-12">
    			<div class="card">
                    ...
                    {{ Form::open(['url' => 'referensi/retribusi-item/'.$kat->id.'/edit']) }}
                    ...
                    <footer class="card-footer text-left">
                        ...
                        <a href="{{ url('referensi/retribusi-item',$kat->getParent->id) }}" class="btn btn-label btn-danger btn-sm"><label><i class="ti-close"></i></label> Batal</a>
                    </footer>
                    {{ Form::close() }}
    			</div>
    		</div>
