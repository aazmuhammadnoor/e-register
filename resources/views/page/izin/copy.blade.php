    	...
    	<div class="row">
    		<div class="col-12">
    			<div class="card">
                    ...
                    {{ Form::open(['url' => 'referensi/perizinan/add','files'=>true,'id'=>'form-xxx']) }}
    				<div class="card-body">
                        @if ($errors->any())
                        ...
                        <div class="row">
                            ...
                            <div class="col-4">
                                {!! Form::label('name','Pembayaran Retribusi',['class'=>'require']) !!}
                            ...
                            <div class="col-12">
                                ...
                                <small class="text-info">Untuk metadata <code>nama_pemohon, nik,no_telepon, badan_usaha,kecamatan,kelurahan,padukuhan</code> yang berkaitan dengan lokasi perizinan tidak perlu dimasukan</small>
                                </p>
                                ...
                                <div class="form-group">
                                    <div class="input-group form-type-combine file-group">
                                        <div class="input-group-input">
                                            ...
                                            {{ Form::text('file_value', null,['class'=>'form-control file-value'] ) }}
