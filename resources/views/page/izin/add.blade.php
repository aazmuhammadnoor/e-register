        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    {{ Form::open(['url' => 'referensi/perizinan/add','files'=>true]) }}
                    <div class="card-body">
                        @if ($errors->any())
                        ...
                        <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="kategori" class="form-control form-control-sm" data-provide="selectpicker" id="kategori">
                                        ...
                                        @foreach($kategori as $mn)
                                            <option value="{{ $mn->id }}" {{ (old('kategori') == $mn->id) ? "selected" : "" }}>{{ $mn->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-4">
                                ...
                                {!! Form::select('biaya_retribusi',$retribusi,null,['class'=>'form-control','data-provide'=>'selectpicker']) !!}
                            </div>
                            <div class="col-4">
                                <div class="form-group">
                                    ...
                                    <div class="custom-controls-stacked">
                                        <label class="custom-control custom-radio">
                                            {{ Form::radio('penanda_tangan_akhir', 'kepala_dinas' , true,['class'=>'custom-control-input'] ) }}
                                            <span class="custom-control-indicator"></span>
                                            <span class="custom-control-description">Kepala Dinas</span>
                                        </label>
                                        <label class="custom-control custom-radio">
                                            {{ Form::radio('penanda_tangan_akhir', 'bupati' , null,['class'=>'custom-control-input'] ) }}
                                            <span class="custom-control-indicator"></span>
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    {!! Form::textarea('dasar_hukum',old('dasar_hukum'),['class'=>'form-control','data-provide'=>'summernote','data-toolbar'=>'slim','data-min-height'=>'150']) !!}
                                </div>
                            </div>
                            <div class="col-12">
                                <p>
...
<a class="dropdown-item text-danger"" data-role="remove"><i class="ti-trash"></i> Delete</a>
                                ...
                                <div class="form-group">
                                    <div class="input-group form-type-combine file-group">
                                        <div class="input-group-input">
                                            ...
                                            {{ Form::text('file_value', null,['class'=>'form-control file-value','required'=>'required'] ) }}
                                ...
                                <div class="form-group">
                                    <div class="input-group form-type-combine file-group">
                                        <div class="input-group-input">
                                            ...
                                            {{ Form::text('template_pendaftaran_value', null,['class'=>'form-control file-value','required'=>'required'] ) }}
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <div class="scrollable flex-grow" style="height: 250px;padding:20px;">
