    	...
    	<div class="row">
    		<div class="col-12">
    			<div class="card">
                    ...
                    {{ Form::open(['url' => 'admin/config/menu/add']) }}
    				<div class="card-body form-type-fill">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <select name="parent" class="form-control form-control-sm select2" data-provide="selectpicker" id="parent">
                                    <option value=""> - </option>
                                    @foreach($menu as $mn)
                                        <option value="{{ $mn->id }}">{{ $mn->label }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                {!! Form::text('label',old('label'),['class'=>'form-control form-control-sm']) !!}
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-2 col-form-label require">Route URL</label>
                            <div class="col-sm-3">
                                {!! Form::text('url',old('url'),['class'=>'form-control form-control-sm']) !!}
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                {!! Form::text('icon','icon ti-server',['class'=>'form-control form-control-sm']) !!}
                            </div>
                        </div>
                    ...
                    <footer class="card-footer text-left">
                        ...
                        <a href="{{ url('config/menu') }}" class="btn btn-label btn-danger btn-sm"><label><i class="ti-close"></i></label> Batal</a>
                    </footer>
                    {{ Form::close() }}
    			</div>
    		</div>
