        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    {{ Form::open(['url' => 'referensi/kecamatan/'.$prov->id.'/'.$kab->id.'/'.$kec->id.'/edit']) }}
                    ...
                    <div class="card-body form-type-fill">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                {!! Form::text('name',$kec->name,['class'=>'form-control form-control-sm','required']) !!}
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-3 col-form-label require">Kode</label>
                            <div class="col-sm-3">
                                {!! Form::text('kode_kec',$kec->kode_kec,['class'=>'form-control form-control-sm','required']) !!}
                            </div>
                        </div>
                    </div>
