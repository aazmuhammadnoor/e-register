    	...
    	<div class="row">
    		<div class="col-12">
    			<div class="card">
                    ...
                    {{ Form::open(['url' => 'admin/pengumuman/'.$id->id.'/edit']) }}
    				<div class="card-body">
                        @if ($errors->any())
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    {!! Form::text('judul',$id->judul,['class'=>'form-control']) !!}
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    {!! Form::textarea('isi',$id->isi,['class'=>'form-control','data-provide'=>'summernote','data-toolbar'=>'slim','data-min-height'=>'150']) !!}
                                </div>
                            </div>
                        </div>
                        <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="custom-controls-stacked">
                                        <label class="custom-control custom-radio">
                                            {{ Form::radio('publish', "Publik" , ($id->publish == 'Publik') ? true : null,['class'=>'custom-control-input'] ) }}
                                            <span class="custom-control-indicator"></span>
                                            <span class="custom-control-description">Publik</span>
                                        </label>
                                        <label class="custom-control custom-radio">
                                            {{ Form::radio('publish', "Member" , ($id->publish == 'Member') ? true : null,['class'=>'custom-control-input'] ) }}
                                            <span class="custom-control-indicator"></span>
                                            <span class="custom-control-description">Member</span>
                                        </label>
                                        <label class="custom-control custom-radio">
                                            {{ Form::radio('publish', "Keduanya" , ($id->publish == 'Keduanya') ? true : null,['class'=>'custom-control-input'] ) }}
                                            <span class="custom-control-indicator"></span>
                                            <span class="custom-control-description">Keduanya</span>
                                        </label>
                                        <label class="custom-control custom-radio">
                                            {{ Form::radio('publish', "Tidak Aktif" , ($id->publish == 'Tidak Aktif') ? true : null,['class'=>'custom-control-input'] ) }}
                                            <span class="custom-control-indicator"></span>
