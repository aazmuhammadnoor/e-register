        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        {!! Form::open(['url'=>'laporan/rekap-permohonan','target'=>'_blank']) !!}
                            <div class="form-group row">
                                {!! Form::label('bulan','Bulan',['class'=>'col-sm-2 col-form-label']) !!}
                                <div class="col-sm-2">
                                    <select name="bulan" class="form-control">
                                        @for($i=1; $i<=12; $i++)
                                            <option value="{{ $i }}" {{ ($i == date('m')) ? "selected" : "" }}>{{ date_month($i) }}</option>
                                        @endfor
                                    </select>
                                </div>
                                {!! Form::label('tahun','Tahun',['class'=>'col-sm-1 col-form-label']) !!}
                                <div class="col-sm-2">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <div class="form-check form-check-inline">
                                        <label class="form-check-label">
                                            {!! Form::radio('format','all_excel',false,['class'=>'form-check-input'])!!} Semua Field Dalam Excel
                                        </label>
                                    </div>
                                </div>
                            </div>
