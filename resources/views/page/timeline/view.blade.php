@if($per->izin_lama)
	<div class="alert alert-warning">
		Timeline tidak dapat di trace, <br/>Data dari Aplikasi Perizinan Lama
	</div>
@else
<a href="{{ url('perizinan/timeline',[$per->id,'cetak']) }}" target="_blank" class="btn btn-sm btn-primary"><i class="fa fa-print"></i> Cetak </a>
            ...
            <div class="timeline-content">
                ...
                <p>
                    ...
                    <i class="fs-16 w-20px pe-7s-note2"></i>
						{{ text_status_permohonan($rs->sub_task) }}
