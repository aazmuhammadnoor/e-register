    		...
    		<div class="col-12">
    			<div class="card">
    				...
    				<div class="card-body">
    					...
    					@include('admin.proses.kasi.bahas-teknis.toolbar')
    					@if($rs->count() > 0)
    								...
    								<tr class="{{ ($row->getWorkflowStatus->getSubtask()->latest()->first()->event != 'mulai') ? "bl-3 border-success" : "bl-3 border-danger bg-pale-warning" }}">
                                        ...
                                        <td class="text-center table-actions">
                                            ...
                                            <a href="#" class="table-action hover-primary"
                                                data-url="{{ url('admin/proses/kasi/bahas-teknis/view',[$row->id]) }}"
                                                data-title="Detail Data Permohonan" data-type="fill" data-size="lg"
                                                data-provide="tooltip modaler" data-original-title="View Data Permohonan">
                                                <i class="ti-layers"></i>
                                            </a>
                                            {{-- @endcan --}}

                                            {{-- @can('verifikasi-pendaftaran') --}}
                                            <a href="{{ url('admin/proses/kasi/bahas-teknis/submit',[$row->id]) }}"
                                                class="table-action hover-primary"
                                                data-provide="tooltip" data-original-title="Submit ke Korlap">
