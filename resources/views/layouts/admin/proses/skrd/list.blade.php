    								...
    								<tr class="{{ ($row->getWorkflowStatus->getSubtask()->latest()->first()->event != 'mulai') ? "bl-3 border-success" : "bl-3 border-danger bg-pale-warning" }}">
                                        ...
                                        <td class="text-center table-actions">
                                            ...
                                            <a href="{{ url('admin/proses/skrd/edit',[$row->id]) }}"
                                                ...
                                                data-provide="tooltip" data-original-title="Input Data SKRD">
                                                <i class="ti-pencil-alt"></i>
                                            </a>

                                            <a href="{{ url('admin/proses/skrd/draft',[$row->id]) }}"
                                                class="table-action hover-primary"
                                                data-provide="tooltip" data-original-title="Lihat Draft SKRD">
                                                <i class="ti-printer"></i>
                                            </a>

                                            <a href="{{ url('admin/proses/skrd/skedit',[$row->id]) }}"
                                                class="table-action hover-primary text-success"
                                                data-provide="tooltip" data-original-title="Input Data SK">
                                                <i class="ti-pencil-alt"></i>
                                            </a>

                                            <a href="{{ url('admin/proses/skrd/skdraft',[$row->id]) }}"
                                                class="table-action hover-primary text-success"
