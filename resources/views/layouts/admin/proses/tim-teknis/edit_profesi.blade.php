...
<main>
    <div class="main-content">
        <ol class="breadcrumb breadcrumb-arrow">
            ...
            <li class="breadcrumb-item"><a href="{{ url('admin/proses/tim-teknis') }}">Daftar Permohonan</a></li>
    				...
    				<div class="card-body">
						...
						<form class="form-horizontal" method="POST" action="{{ url()->current() }}">					
							...
							<div class="row">
								<div class="col-12">
									<div class="form-group">
										<label class="control-label require">Hasil Survey</label>
									</div>
								</div>
								<div class="col-12">
									<div class="btn-toolbar float-right">
										<div class="btn-group btn-group-sm">
											<button type="button" class="btn" title="" data-provide="tooltip"  data-original-title="Tambah" id="modal-tambah" data-toggle="modal" data-target="#modal-survey"><i class="ti-plus"></i> Tambah</button>
										</div>
									</div>									
								</div>
								<div class="col-12">
		    						...
		    						<table class="table table-sm table-striped small">
		    							...
		    							<tbody>
		    								...
		    								<tr>
		    									...
		    									<td class="text-center">
													<a href="{{ url('admin/proses/tim-teknis/delete',[$row->id,$per->id]) }}"
							...
							<div class="form-group">
	                            ...
	                            <a href="{{ url('admin/proses/tim-teknis') }}" class='btn btn-label btn-danger'><label><i class="ti-close"></i></label> Batal</a>
							</div>
						</form>
    				</div>
    			</div>
