...
<main>
    <div class="main-content">
        <ol class="breadcrumb breadcrumb-arrow">
            ...
            <li class="breadcrumb-item"><a href="{{ url('admin/proses/cetak-spm') }}">Daftar Permohonan</a></li>
    				...
    				<div class="card-body">
						...
						<form class="form-horizontal" method="POST" action="{{ url()->current() }}">
							...
							<div class="form-group">
	                            ...
	                            <a href="{{ url('admin/proses/cetak-spm') }}" class='btn btn-label btn-danger'><label><i class="ti-close"></i></label> Batal</a>
							</div>						
						</form>						
    				</div>
    			</div>
