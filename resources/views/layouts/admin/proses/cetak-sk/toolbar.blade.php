<div class="flexbox mb-20">
	...
	<div class="btn-toolbar">
		<div class="btn-group btn-group-sm">
			...
			<button onclick="javascript:window.location.href='{{ url('admin/proses/cetak-sk') }}'" class="btn" title="" data-provide="tooltip" data-original-title="Refresh"><i class="ion-refresh"></i> Refresh</button>
		</div>
	</div>
</div>
