...
<main>
    <div class="main-content">
        <ol class="breadcrumb breadcrumb-arrow">
            ...
            <li class="breadcrumb-item"><a href="{{ url('admin/proses/pendaftaran') }}">Daftar Permohonan</a></li>
    				...
    				<div class="card-body">
						...
						<table class="table-dot table-sm">
							...
							<tr>
								...
								<td>: {{ $per->getPemohon ? $per->getPemohon->jenis_kelamin == 1 ? 'Laki-Laki' : 'Perempuan' : '' }}</td>
						...
						<form class="form-horizontal" method="POST" action="{{ url()->current() }}">
							...
							<table class="table table-sm">
								<thead>
									<tr>
										...
										<th class="text-center">Lengkap/Tidak</th>
									</tr>
								</thead>
								<tbody>
							...
							<div class="form-group">
								<div class="form-check form-check-inline">
								  <label class="form-check-label">
								    <input class="form-check-input" type="radio" name="hasil_pemeriksaan" value="1"> Lengkap
								  </label>
								</div>
								<div class="form-check form-check-inline">
								  <label class="form-check-label">
							...
							<div id="spm">
								<div class="divider text-primary">INPUT DATA SPM</div>
								<div class="form-group">
									<label for="alamat" class="control-label require">Catatan</label>
									<textarea class="form-control" name="catatan_spm"></textarea>
								</div>								
							</div>
							@endif
							<div class="form-group">
