    				...
    				<div class="card-body">
						...
						<form class="form-horizontal" method="POST" action="{{ url()->current() }}">
							...
							<div class="form-group">
								<label for="alamat" class="control-label require">Nama TTD</label>
								<input type="text" class="form-control" name="catatan_pembahasan_teknis"></textarea>
							</div>
							<div class="form-group">
								<label for="alamat" class="control-label require">NIP TTD</label>
								<input type="text" class="form-control" name="catatan_pembahasan_teknis"></textarea>
							</div>
							<div class="form-group">
								<label for="alamat" class="control-label require">Nomor SK</label>
								<input type="text" class="form-control" name="catatan_pembahasan_teknis"></textarea>
							</div>							
							<div class="form-group">
