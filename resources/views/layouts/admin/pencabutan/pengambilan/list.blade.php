    		...
    		<div class="col-12">
    			<div class="card">
    				...
    				<div class="card-body">
    					...
    					@include('admin.pencabutan.pengambilan.toolbar')
    					@if($rs->count() > 0)
    								...
    								<tr>
                                        ...
                                        <td class="text-center table-actions">
                                            ...
                                            <a href="{{ url('admin/pencabutan/pengambilan/notif',[$row->id]) }}"
                                                ...
                                                data-provide="tooltip" data-original-title="Notifikasi Pemohon">
                                                <i class="ti-comment-alt"></i>
                                            </a>

                                            <a href="{{ url('admin/pencabutan/pengambilan/edit',[$row->id]) }}"
                                                class="table-action hover-primary"
                                                data-provide="tooltip" data-original-title="Pengambilan SK Pencabutan Izin">
                                                <i class="ti-pencil-alt"></i>
                                            </a>

                                            <a href="{{ url('admin/pencabutan/pengambilan/draft',[$row->id]) }}"
                                                class="table-action hover-primary"
                                                data-provide="tooltip" data-original-title="Cetak Draft SK">
