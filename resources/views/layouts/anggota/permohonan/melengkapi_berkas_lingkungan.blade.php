            ...
            <div class="col-12">
                ...
                <div class="card card-body" data-provide="wizard">
                    ...
                    <div class='row'>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="id_profil" class="control-label require">Jenis Kegiatan</label>
                                <select id="id_profil" class="form-control show-tick" data-provide="selectpicker" title="Pilih Jenis Kegiatan..." name="id_profil" required="">
                                    @foreach($pendaftar->lingkungans as $pf)
                                        <option value="{{ $pf->id }}">{{ $pf->jenis_kegiatan }}</option>
                                    @endforeach
                                </select>                                        
                            </div>
                        </div>
