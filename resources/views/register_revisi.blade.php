            ...
            <div class="eregister-register-page">
                ...
                <div class="right-content">
                    ...
                    <form id="form-submit-register">
                        ...
                        <div class="row mt-5 mb-4" id="button-review-form" style="display: none">
                            <div class="col-12">
                                <div class="d-flex flex-row justify-content-between">
                                    <div>
                                        <a href="#" script="javascript:void(0)" class="btn btn-outline-dark btn-form-cancel">Batal</a>
                        ...
                        <div class="row mt-5 mb-4" id="button-final-form" style="display: none">
                            <div class="col-12">
                                <div class="d-flex flex-row justify-content-between">
                                    <div>
                                        <a href="#" script="javascript:void(0)" class="btn btn-outline-dark btn-form-cancel">Batal</a>
                                    </div>
                                    <a href="#!" script="javascript:void(0)" class="btn btn-secondary text-white current-btn" id="button-revisi">Simpan</a>
                                </div>
                            </div>
                        </div>
                    </form>
...
@section('js')
    ...
    @endforeach
        ...
        function revisiLoad()
        {
            let token = '{{ $register->thisTempRegister->token }}';
            let key = '{{ bcrypt($register->thisTempRegister->token) }}';
            let submited = '{{ date('Y-m-d') }}';
            let step = steps[0];
            tempStore(token,key,submited,step);
        }
        ...
        function url_final()
        {
            return '{{ route('mypage.register.update',[$form_register->url,$register->id]) }}';
        }
        ...
        {
            return '{{ route('mypage.register',[$form_register->url,$register->id]) }}';
        }
