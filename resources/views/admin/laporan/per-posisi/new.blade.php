                              ...
                              <table class="table table-bordered">
                                ...
                                <tbody>
                                  ...
                                  <tr>  
                                    ...
                                    <th>{{$rs->izin}}</th>
                                    <th class="text-right">{{$rs->pemohon}}</th>
                                    <th class="text-right">{{$rs->fo}}</th>
                                    <th class="text-right">{{$rs->kasi_berkas}}</th>
                                    <th class="text-right">{{$rs->kasi_cetak_sk}}</th>
                                    <th class="text-right">{{$rs->korlap}}</th>
                                    <th class="text-right">{{$rs->korlap_bap}}</th>
                                    <th class="text-right">{{$rs->tim_teknis}}</th>
                                    <th class="text-right">{{$rs->bo_cetak_sk}}</th>
                                    <th class="text-right">{{$rs->bo_cetak_spm}}</th>
                                    <th class="text-right">{{$rs->bo_skrd}}</th>
                                    <th class="text-right">{{$rs->kabid}}</th>
                                    <th class="text-right">{{$rs->kadin}}</th>
                                    <th class="text-right">{{$rs->pengambilan}}</th>
                                    <th class="text-right">{{$rs->arsip}}</th>
                                    <th class="text-right">{{$rs->tolak}}</th>
