    		...
    		<div class="col-12">
                ...
                <form class="form-horizontal" method="POST" action="{{ url()->current() }}">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                            <select class="form-control show-tick" data-provide="selectpicker" title="Pilih Kecamatan..." name="kecamatan">
                  ...
                  <div class="col-md-12">
                      <div class="card">
                          <div class="card-header">
                            <h5 class="card-title">Jumlah Permohonan: <strong>{{ $count_status }}</strong></h5>
                            @if ($count_status > 0)
                             @if ($format == 'html')
                                <a href="{{ url('admin/laporan/per-wilayah/total',[$kecamatan]) }}"
                                    class="btn btn-sm btn-bold btn-round btn-outline btn-success w-120px">
                                    Lihat
                                </a>
                                @else 
                                <a href="{{ url('admin/laporan/per-wilayah/total/excel',[$kecamatan]) }}"
                                    class="btn btn-sm btn-bold btn-round btn-outline btn-success w-120px">
                                    Excel
                                </a>
                              @endif
                          ...
                          <div class="media-list media-list-hover media-list-divided">
                              ...
                              <div class="media media-single">
                                ...
                                <div class="media-right">
                                  @if ($profils->total > 0)
                                   @if ($format == 'html')
                                      <a href="{{ url('admin/laporan/per-wilayah/kat',[$profils->id, $kecamatan]) }}"
                                          class="btn btn-sm btn-bold btn-round btn-outline btn-success w-120px">
                                          Lihat
                                      </a>
                                      @else 
                                      <a href="{{ url('admin/laporan/per-wilayah/kat/excel',[$profils->id, $kecamatan]) }}"
                                          class="btn btn-sm btn-bold btn-round btn-outline btn-success w-120px">
                                          Excel
                                      </a>
                                    @endif
