                  ...
                  <div class="col-md-12">
                      <div class="card">
                          <div class="card-header">
                            ...
                            @if ($count_status > 0)
                             @if ($format == 'html')
                                <a href="{{ url('admin/laporan/rekapitulasi/total') }}"
                                    class="btn btn-sm btn-bold btn-round btn-outline btn-success w-120px">
                                    Lihat
                                </a>
                                @else 
                                <a href="{{ url('admin/laporan/rekapitulasi/total/excel') }}"
                                    class="btn btn-sm btn-bold btn-round btn-outline btn-success w-120px">
                                    Excel
                                </a>
                              @endif
                          ...
                          <div class="media-list media-list-hover media-list-divided">
                              ...
                              <div class="media media-single">
                                ...
                                <div class="media-right">
                                  @if ($profils->total > 0)
                                   @if ($format == 'html')
                                      <a href="{{ url('admin/laporan/rekapitulasi/kat',[$profils->id]) }}"
                                          class="btn btn-sm btn-bold btn-round btn-outline btn-success w-120px">
                                          Lihat
                                      </a>
                                      @else 
                                      <a href="{{ url('admin/laporan/rekapitulasi/kat/excel',[$profils->id]) }}"
                                          class="btn btn-sm btn-bold btn-round btn-outline btn-success w-120px">
                                          Excel
                                      </a>
                                    @endif
