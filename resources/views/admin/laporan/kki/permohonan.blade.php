                              ...
                              <table class="table table-bordered table-hover">
                                ...
                                <tbody>
                                  ...
                                  <tr>  
                                    ...
                                    <th>{{($rs->getProfesi) ? is_date($rs->getProfesi->berlaku_mulai) : "-"}}</th>
                                    <th>{{($rs->getProfesi) ? is_date($rs->getProfesi->berlaku_sampai) : "-"}}</th>
                                    <th>{{($rs->getProfesi) ? date_id($rs->tgl_pendaftaran) : "-"}}</th>
