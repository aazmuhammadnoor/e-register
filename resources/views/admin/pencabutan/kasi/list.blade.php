    		...
    		<div class="col-12">
    			<div class="card">
    				...
    				<div class="card-body">
                        ...
                        {!! Form::open(['url'=>'admin/pencabutan/kasi/lists/'.$kat->id,'method'=>'get','class'=>'form-inline pull-right']) !!}
    							...
    							<tbody>
    								...
    								<tr>
                                        ...
                                        <td class="text-center table-actions">
                                            ...
                                            @if($row->no_sk)
                                                <a href="{{ url('admin/pencabutan/kasi/cetak',[$row->id]) }}"
                                                class="table-action hover-primary btn btn-danger p-1 text-white"
                                                data-provide="tooltip" data-original-title="Cetak" target="_blank" id="cetak">
                                                    <i class="ti-printer"></i>
                                                </a>
                                                @if(file_exists(dokumen_path_pencabutan($row)."/SK_PENCABUTAN_".str_slug($row->getPermohonan->getIzin->nama)."_".str_slug($row->no_pencabutan).".pdf"))
