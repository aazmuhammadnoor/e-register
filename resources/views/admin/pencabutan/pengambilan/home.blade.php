...
<main>
    <div class="main-content">
        <ol class="breadcrumb breadcrumb-arrow">
            ...
            <li class="breadcrumb-item active">Dashboard Pengambilan Berkas Pencabutan</li>
        </ol>
    	<div class="row">
    		<div class="col-12">
    			<div class="card">
    				<h4 class="card-title">Dashboard Pengambilan Berkas Pencabutan</h4>
    				<div class="card-body">
                        @if(!empty($status_profil))
                        <div class="col-md-12">
                            <div class="card">
                                <h5 class="card-title">Jumlah Pengambilan Berkas Pencabutan: <strong>{{ $count_status }}</strong></h5>
                                ...
                                <div class="media media-single">
                                  ...
                                  <div class="media-right">
                                    @if ($num > 0)
                                        <a href="{{ url('admin/pencabutan/pengambilan/lists',[$kategori->id]) }}"
