    		...
    		<div class="col-12">
    			<div class="card">
    				...
    				<div class="card-body">
                        ...
                        {!! Form::open(['url'=>'admin/pencabutan/pengambilan/lists/'.$kat->id,'method'=>'get','class'=>'form-inline pull-right']) !!}
    							...
    							<tbody>
    								...
    								<tr>
                                        ...
                                        <td class="text-center table-actions">
                                            ...
                                            <a href="{{ url('admin/pencabutan/pengambilan/notif',[$row->id]) }}"
                                                class="table-action hover-danger btn btn-info p-1 text-white"
                                                data-provide="tooltip" data-original-title="Kirim Email">
                                                <i class="ti-share"></i>
                                            </a>

                                            <a href="{{ url('admin/pencabutan/pengambilan/edit',[$row->id]) }}"
                                                class="table-action hover-danger btn btn-primary p-1 text-white"
                                                data-provide="tooltip" data-original-title="Proses">
                                                <i class="ti-files"></i>
                                            </a>

                                            <a href="{{ url('admin/pencabutan/download-sk',[$row->id]) }}"
                                                class="table-action hover-primary btn btn-danger p-1 text-white"
                                                data-provide="tooltip" data-original-title="Proses" target="_blank">
