...
<main>
    <div class="main-content">
    	...
    	<div class="row">
    		<div class="col-12">
    			<div class="card">
    				<h4 class="card-title">Dashboard Pengaduan</h4>
    				<div class="card-body">
                        @if(!empty($status_profil))
                        <div class="col-md-12">
                            <div class="card">
                                <h5 class="card-title">Jumlah Pengaduan: <strong>{{ $count_status }}</strong></h5>
                                <div class="media-list media-list-hover media-list-divided">
                                    ...
                                    <div class="media media-single">
                                      ...
                                      <div class="media-right">
                                        @if ($profils->total > 0)
                                          <a href="{{ url('admin/pencabutan/pendaftaran/lists',[$profils->id]) }}"
