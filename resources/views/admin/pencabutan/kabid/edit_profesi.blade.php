...
<main>
    <div class="main-content">
        <ol class="breadcrumb breadcrumb-arrow">
            ...
            <li class="breadcrumb-item"><a href="{{ url('admin/pencabutan/kabid') }}">Daftar Permohonan</a></li>
    				...
    				<div class="card-body">
						...
						<form class="form-horizontal" method="POST" action="{{ url()->current() }}">					
							...
							<div class="form-group">
								...
								<textarea class="form-control" name="catatan_kabid"></textarea>
							</div>
							<div class="form-group">
	                            <button class="btn btn-label btn-primary" type="submit"><label><i class="ti-check"></i></label> Simpan</button>
	                            <a href="{{ url('admin/pencabutan/kabid') }}" class='btn btn-label btn-danger'><label><i class="ti-close"></i></label> Batal</a>
							</div>
						</form>
    				</div>
    			</div>
