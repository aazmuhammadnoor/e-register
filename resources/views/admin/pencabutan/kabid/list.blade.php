    		...
    		<div class="col-12">
    			<div class="card">
    				...
    				<div class="card-body">
                        ...
                        {!! Form::open(['url'=>'admin/pencabutan/kabid/lists/'.$kat->id,'method'=>'get','class'=>'form-inline pull-right']) !!}
    							...
    							<tbody>
    								...
    								<tr>
                                        ...
                                        <td class="text-center table-actions">
                                            ...
                                            <a href="{{ url('admin/pencabutan/kabid/edit',[$row->id]) }}"
                                            ...
                                            @if($row->no_sk)
                                                <a href="{{ url('admin/pencabutan/kabid/cetak',[$row->id]) }}"
