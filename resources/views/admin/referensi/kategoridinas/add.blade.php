    	...
    	<div class="row">
    		<div class="col-12">
    			<div class="card">
                    ...
                    {{ Form::open(['url' => 'referensi/kategori-dinas/add']) }}
    				<div class="card-body">
                        @if ($errors->any())
                        ...
                        <div class="row">
                            ...
                            <div class="col-2">
                                <div class="form-group">
                                    ...
                                    {!! Form::text('singkatan_dinas',old('singkatan_dinas'),['class'=>'form-control form-control-sm']) !!}
                                </div>
                            </div>
                            <div class="col-8">
                                <div class="form-group">
                                    {!! Form::label('alamat_dinas','Alamat Dinas',['class'=>'require']) !!}
                                    {!! Form::text('alamat_dinas',old('alamat_dinas'),['class'=>'form-control form-control-sm']) !!}
                                </div>
                            </div>
                            <div class="col-4">
                                <div class="form-group">
                                    {!! Form::label('telp','No Telp Dinas',['class'=>'require']) !!}
                                    {!! Form::text('telp',old('telp'),['class'=>'form-control form-control-sm']) !!}
                                </div>
                            </div>
                            <div class="col-4">
                                <div class="form-group">
                                    {!! Form::label('nama_kepala','Nama Kepala Dinas',['class'=>'require']) !!}
                                    {!! Form::text('nama_kepala',old('nama_kepala'),['class'=>'form-control form-control-sm']) !!}
                                </div>
                            </div>
                            <div class="col-3">
                                <div class="form-group">
                                    {!! Form::label('nip_kepala','NIP Kepala Dinas',['class'=>'require']) !!}
                                    {!! Form::text('nip_kepala',old('nip_kepala'),['class'=>'form-control form-control-sm']) !!}
                                </div>
                            </div>
                            <div class="col-3">
                                <div class="form-group">
                                    {!! Form::label('pangkat_kepala','Pangkat Kepala Dinas',['class'=>'require']) !!}
                                    {!! Form::text('pangkat_kepala',old('pangkat_kepala'),['class'=>'form-control form-control-sm']) !!}
                                </div>
                            </div>
                            <div class="col-2">
                                <div class="form-group">
                                    {!! Form::label('golongan_kepala','Golongan Kepala Dinas',['class'=>'require']) !!}
                                    {!! Form::text('golongan_kepala',old('golongan_kepala'),['class'=>'form-control form-control-sm']) !!}
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <select name="bidang_izin_id" class="form-control form-control-sm" data-provide="selectpicker" data-url="{{ url('ajax/seksi-izin') }}" id="bidang_izin_id">
                                        ...
                                        @foreach($bidangIzin as $mn)
                                            <option value="{{ $mn->id }}" {{ (old('bidang_izin_id') == $mn->id) ? "selected" : "" }}>{{ $mn->nama }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
