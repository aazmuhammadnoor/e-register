                        ...
                        <div class="row">
                            ...
                            <div class="col-3">
                                <div class="form-group">
                                    ...
                                    {!! Form::text('kode_depan_izin',$jenP->kode_depan_izin,['class'=>'form-control form-control-sm']) !!}
                                </div>
                            </div>
                            <div class="col-3">
                                <div class="form-group">
                                    {!! Form::label('singkatan_jenis_izin','Singkatan SK Izin',['class'=>'require']) !!}
                                    {!! Form::text('singkatan_jenis_izin',$jenP->singkatan_jenis_izin,['class'=>'form-control form-control-sm']) !!}
                                </div>
                            </div>
                            <div class="col-3">
                                <div class="form-group">
                                    {!! Form::label('kode_sk_tengah','Kode Tengah SK',['class'=>'require']) !!}
                                    {!! Form::text('kode_sk_tengah',$jenP->kode_sk_tengah,['class'=>'form-control form-control-sm']) !!}
                                </div>
                            </div> 
                            <div class="col-3">
                                <div class="form-group">
                                    {!! Form::label('nomor_default_pendaftaran','Nomor Default Pendaftaran',['class'=>'require']) !!}
                                    {!! Form::text('nomor_default_pendaftaran',$jenP->nomor_default_pendaftaran,['class'=>'form-control form-control-sm']) !!}
                                </div>
                            </div>
                            <div class="col-3">
                                <div class="form-group">
                                    {!! Form::label('nomor_default_sk','Nomor Default SK',['class'=>'require']) !!}
                                    {!! Form::text('nomor_default_sk',$jenP->nomor_default_sk,['class'=>'form-control form-control-sm']) !!}
                                </div>
                            </div>
                            <div class="col-4">
                                <div class="form-group">
                                    ...
                                    <select name="jenis_permohonan" class="form-control form-control-sm" data-provide="selectpicker" id="jenis_permohonan">
                                        ...
                                        @foreach($jenisPermohonan as $mn)
                                            <option value="{{ $mn }}" {{ ($jenP->jenis_permohonan == $mn) ? "selected" : "" }}>{{ $mn }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            <div class="col-3">
                                <div class="form-group">
                                    ...
                                    {!! Form::text('limit',$jenP->limit,['class'=>'form-control form-control-sm']) !!}
                                </div>
                            </div>
                            <div class="col-4">
                                <div class="form-group">
                                    ...
                                    <select name="penomoran_sk" class="form-control form-control-sm" data-provide="selectpicker" id="penomoran_sk">
                                        ...
                                        @foreach($nomorSK as $mn)
                                            <option value="{{ $mn }}" {{ ($jenP->penomoran_sk == $mn) ? "selected" : "" }}>{{ $mn }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="ceklis" class="form-control form-control-sm" data-provide="selectpicker" id="ceklis">
                                        ...
                                        @foreach($ceklis as $mn)
                                            <option value="{{ $mn }}" {{ ($jenP->ceklis == $mn) ? "selected" : "" }}>{{ $mn }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    {!! Form::textarea('script_extended',$jenP->script_extended,['class'=>'form-control form-control-sm','placeholder'=>'Script JS Tambahan untuk validasi permohonan di pemohon']) !!}
                                </div>
                            </div>
                            <div class="col-12">
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    <div class="input-group form-type-combine file-group">
                                        <div class="input-group-input">
                                            @if($jenP->template_surat)
                                                <a href="{{ url('download_admin/'.$jenP->template_surat) }}">Download</a>
                                            @endif
                                            {!! Form::label('name','Pilih File Template SK/Surat Perizinan dalam format .docx',['class'=>'required']) !!}
                                            {{ Form::text('template_surat_value', $jenP->template_surat,['class'=>'form-control file-value'] ) }}
                                ...
                                <div class="form-group">
                                    <div class="input-group form-type-combine file-group">
                                        <div class="input-group-input">
                                            @if($jenP->template_pendaftaran)
                                                <a href="{{ url('download_admin/'.$jenP->template_pendaftaran) }}">Download</a>
                                            @endif
                                ...
                                <div class="form-group">
                                    <div class="input-group form-type-combine file-group">
                                        <div class="input-group-input">
                                            @if($jenP->template_bukti_pendaftaran)
                                                <a href="{{ url('download_admin/'.$jenP->template_bukti_pendaftaran) }}">Download</a>
                                            @endif
                                            {!! Form::label('name','Pilih File Template Bukti Pendaftaran Perizinan dalam format .docx',['class'=>'']) !!}
                                            {{ Form::text('template_bukti_pendaftaran_value', $jenP->template_bukti_pendaftaran,['class'=>'form-control file-value'] ) }}
                                ...
                                <div class="form-group">
                                    <div class="input-group form-type-combine file-group">
                                        <div class="input-group-input">
                                            @if($jenP->template_rekomendasi)
                                                <a href="{{ url('download_admin/'.$jenP->template_rekomendasi) }}">Download</a>
                                            @endif
                                            {!! Form::label('name','Pilih File Template Rekomendasi Teknis dalam format .docx',['class'=>'']) !!}
                                            {{ Form::text('template_rekomendasi_value', $jenP->template_rekomendasi,['class'=>'form-control file-value'] ) }}
                                ...
                                <div class="form-group">
                                    <div class="input-group form-type-combine file-group">
                                        <div class="input-group-input">
                                            @if($jenP->template_pencabutan)
                                                <a href="{{ url('download_admin/'.$jenP->template_pencabutan) }}">Download</a>
                                            @endif
                                            {!! Form::label('name','Pilih File Template Pencabutan Teknis dalam format .docx',['class'=>'']) !!}
                                            {{ Form::text('template_pencabutan_value', $jenP->template_pencabutan,['class'=>'form-control file-value'] ) }}
