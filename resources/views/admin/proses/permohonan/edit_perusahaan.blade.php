                            ...
                            <div class='row'>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select id="status_jabatan" class="form-control"  title="Pilih Profesi..." name="status_jabatan" required>
                                            @foreach($status_jabatan as $val)
                                                <option value="{{ $val }}" {{ $per->getPerusahaan != null && $per->getPerusahaan->status_jabatan ==$val ? "selected" : ""}}>{{ $val }}</option>
                                            @endforeach
                                        </select>                                        
                                    </div>
                                </div>
