                        ...
                        {{ Form::open(['url' => url()->current(),'files'=>true]) }}
                            ...
                            <div class='row'>
                                ...
                                @php
                                    ...
                                    $kegiatan = [
                                        'PEMBANGUNAN','USAHA','GALIAN JALAN'
                                    ];
                                @endphp
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="oleh" class="control-label require">Oleh</label>
                                        <select id="oleh" class="form-control"  title="Pilih Profesi..." name="oleh" required>
                                            @foreach($oleh as $val)
                                                <option value="{{ $val }}" {{ $per->getLingkungan != null && $per->getLingkungan->oleh ==$val ? "selected" : ""}}>{{ $val }}</option>
                                            @endforeach
                                        </select>                                        
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select id="jenis_kegiatan" class="form-control"  title="Pilih Profesi..." name="jenis_kegiatan" required>
                                            @foreach($kegiatan as $val)
                                                <option value="{{ $val }}" {{ $per->getLingkungan != null && $per->getLingkungan->jenis_kegiatan ==$val ? "selected" : ""}}>{{ $val }}</option>
                                            @endforeach
                                        </select>                                        
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group{{ $errors->has('nama_perusahaan') ? ' has-error' : '' }}">
                                        ...
                                        <input id="nama_perusahaan" type="text" class="form-control " name="nama_perusahaan" value="{{ $per->getLingkungan->nama_perusahaan }}" >
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group{{ $errors->has('alamat_perusahaan') ? ' has-error' : '' }}">
                                        ...
                                        <input id="alamat_perusahaan" type="text" class="form-control " name="alamat_perusahaan" value="{{ $per->getLingkungan->alamat_perusahaan }}" >
                                    </div>
                                </div>
                                <div class='col-md-12'>
