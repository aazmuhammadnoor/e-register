...
<main>
    <div class="main-content">
        <ol class="breadcrumb breadcrumb-arrow">
            ...
            <li class="breadcrumb-item"><a href="{{ url('admin/proses/kabid/list',[$kat->id]) }}">Daftar Permohonan Bidang {{ $kat->nama }}</a></li>
    	...
    	<div class="row">
    		<div class="col-12">
              ...
              <div class="form-group">
								...
								<textarea class="form-control" name="catatan_kabid_approval_draft">{{ $per->catatan_kabid_approval_draft }}</textarea>
							</div>
							<div class="form-group">
	                            <button class="btn btn-label btn-primary" type="submit"><label><i class="ti-check"></i></label> Proses</button>
	                            <a href="{{ url('admin/proses/kabid/list',[$kat->id]) }}" class='btn btn-label btn-danger'><label><i class="ti-close"></i></label> Batal</a>
							</div>
						</form>
    				</div>
    			</div>
