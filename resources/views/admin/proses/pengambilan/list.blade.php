    		...
    		<div class="col-12">
    			<div class="card">
    				...
    				<div class="card-body">
    					...
    					@include('admin.proses.pengambilan.toolbar')
                        {!! Form::open(['url'=>'admin/proses/pengambilan/list/'.$kat->id,'method'=>'get','class'=>'form-inline pull-right']) !!}
    							...
    							<tbody>
    								...
    								<tr class="{{ ($row->getWorkflowStatus->getSubtask()->latest()->first()->event != 'mulai') ? "bl-3 border-success" : "bl-3 border-danger bg-pale-warning" }}">
                                        ...
                                        <td class="text-center table-actions">
                                            ...
                                            <a href="{{ url('admin/proses/pengambilan/notif',[$row->id]) }}"
                                                class="table-action hover-danger p-1 text-white btn btn-primary"
                                                data-provide="tooltip" data-original-title="Kirim SK ke Email Pemohon">
                                                <i class="ti-arrow-top-right"></i>
                                            </a>

                                            {{-- @can('verifikasi-pendaftaran') --}}
                                            <a href="{{ url('admin/proses/pengambilan/edit',[$row->id]) }}"
                                                class="table-action hover-warning p-1 text-white btn btn-info"
                                                data-provide="tooltip" data-original-title="Pengambilan SK Izin">
                                                <i class="ti-pencil-alt"></i>
                                            </a>
                                            {{-- @endcan --}}

                                            <a href="{{ url('admin/proses/pengambilan/sk',[$row->id]) }}"
                                                class="table-action hover-primary p-1 text-white btn btn-danger"
