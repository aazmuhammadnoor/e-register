    ...
    <section class="container">
        ...
        <div class="row p-4">
            ...
            <div class="col-12 text-left">
                <p>Terimakasih, Permohonan anda dengan detail sebagai berikut:</p>
          <table class="text-left p-2">
            ...
            <div class="col-12 text-center p-2">
                <p class="text-left">Telah selesai kami proses, Silahkan download lampiran pada email dibawah ini.</p>
                <a href="{{ url('permohonan') }}" class="btn">Lihat Permohonan Saya</a>
            </div>
        </div>
      <div class="row p-4">
