...
<main>
    <div class="main-content">
        <ol class="breadcrumb breadcrumb-arrow">
            ...
            <li class="breadcrumb-item active">Inbox Permohonan Pembahasan Teknis</li>
        </ol>
                            ...
                            <div class="media-list media-list-hover media-list-divided">
                                ...
                                <div class="media media-single">
                                  ...
                                  <div class="media-right">
                                    @if ($profils->total > 0)
                                        <a href="{{ url('admin/proses/inbox-korlap/list',[$profils->id]) }}"
                        ...
                        <div class="card">
                            ...
                            <div class="media-list media-list-hover media-list-divided">
                                ...
                                <div class="media media-single">
                                  ...
                                  <div class="media-right">
                                    @if ($profils->total > 0)
                                        <a href="{{ url('admin/proses/outbox-korlap/list',[$profils->id]) }}"
                                            class="btn btn-sm btn-bold btn-round btn-outline btn-success w-120px">
                                            Lihat
                                        </a>
                                    @else
