...
<main>
    <div class="main-content">
        <ol class="breadcrumb breadcrumb-arrow">
            ...
            <li class="breadcrumb-item"><a href="{{ url('admin/proses/kasi/draft') }}">Dashboard Permohonan</a></li>
    		...
    		<div class="col-12">
    			<div class="card">
    				...
    				<div class="card-body">
    					...
    					@include('admin.proses.kasi.draft.toolbar')
                        {!! Form::open(['url'=>'admin/proses/kasi/draft/list/'.$kat->id,'method'=>'get','class'=>'form-inline pull-right']) !!}
    							...
    							<tbody>
    								...
    								<tr class="{{ ($row->getWorkflowStatus->getSubtask()->latest()->first()->event != 'mulai') ? "bl-3 border-success" : "bl-3 border-danger bg-pale-warning" }}">
                                        ...
                                        <td class="text-center table-actions">
                                            ...
                                            <a href="{{ url('admin/proses/kasi/draft/edit',[$row->id]) }}"
                                                class="table-action hover-danger btn btn-primary p-2 text-white"
                                                data-provide="tooltip" data-original-title="Periksa dan Submit ke KABID">
                                                <i class="ti-files"></i>
                                            </a>
                                            {{-- @endcan --}}

                                            <a href="{{ url('admin/proses/kasi/draft/cetak',[$row->id]) }}"
                                                class="table-action hover-primary btn btn-danger p-2 text-white"
