...
<main>
    <div class="main-content">
        <ol class="breadcrumb breadcrumb-arrow">
            ...
            <li class="breadcrumb-item"><a href="{{ url('admin/proses/kasi/approval-berkas') }}">Daftar Permohonan</a></li>
    	...
    	<div class="row">
    		<div class="col-12">
    			<div class="card">
					...
					@include($permohonan_profile)
						...
						<form class="form-horizontal" method="POST" action="{{ url()->current() }}">
							@include('admin.proses.partial.verifikasi_kasi')
              ...
              @include('admin.proses.partial.draftapp')
							<div class="form-group">
								<label for="alamat" class="control-label require">Catatan</label>
								<textarea class="form-control" name="catatan_kasi_approval_berkas">{{ $per->catatan_kasi_approval_berkas }}</textarea>
							</div>
							<div class="form-group">
	                            <button class="btn btn-label btn-primary" type="submit"><label><i class="ti-check"></i></label> Proses</button>
	                            <a href="{{ url('admin/proses/kasi/approval-berkas/list',[$kat->id]) }}" class='btn btn-label btn-danger'><label><i class="ti-close"></i></label> Batal</a>
							</div>
						</form>
    				</div>
    			</div>
