    				...
    				<div class="card-body">
                        ...
                        {{ Form::open(['url' => url()->current(),'files'=>true]) }}
                            ...
                            <div class='row'>
                                ...
                                @php
                                    $sertifikat = [
                                        'Sertifikat Hak Milik (SHM)','Sertifikat Hak Guna Bangunan (SHGB)','Sertifikat Hak Guna Usaha (SHGU)','Sertifikat Hak Satuan Rumah Susun (SHSRS)'
                                    ];
                                @endphp
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="jenis_sertifikat" class="control-label require">Jenis Serfifikat</label>
                                        <select id="jenis_sertifikat" class="form-control"  title="Pilih Profesi..." name="jenis_sertifikat" required>
                                            @foreach($sertifikat as $val)
                                                <option value="{{ $val }}" {{ $per->getPembangunan != null && $per->getPembangunan->jenis_sertifikat ==$val ? "selected" : ""}}>{{ $val }}</option>
                                            @endforeach
                                        </select>                                        
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group{{ $errors->has('nomor_sertifikat') ? ' has-error' : '' }}">
                                        ...
                                        <input id="nomor_sertifikat" type="text" class="form-control " name="nomor_sertifikat" value="{{ $per->getPembangunan->nomor_sertifikat }}" >
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group{{ $errors->has('nama_pada_sertifikat') ? ' has-error' : '' }}">
                                        <label for="nama_pada_sertifikat" class="control-label require">Nama Pada Sertifikat</label>
                                        <input id="nama_pada_sertifikat" type="text" class="form-control " name="nama_pada_sertifikat" value="{{ $per->getPembangunan->nama_pada_sertifikat }}" >
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group{{ $errors->has('tanggal_sertifikat') ? ' has-error' : '' }}">
                                        <label for="tanggal_sertifikat" class="control-label require">Tanggal Pembuatan Sertifikat</label>
                                        <input type="text" class="form-control datepicker" data-provide="datepicker" data-date-today-highlight="true" data-date-format="yyyy-mm-dd" name="tanggal_sertifikat" value="{{ $per->getPembangunan->tanggal_sertifikat }}">
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group{{ $errors->has('luas_tanah') ? ' has-error' : '' }}">
                                        <label for="luas_tanah" class="control-label require">Luas Tanah</label>
                                        <input id="luas_tanah" type="text" class="form-control " name="luas_tanah" value="{{ $per->getPembangunan->luas_tanah }}" >
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group{{ $errors->has('nomor_akte_jual_beli') ? ' has-error' : '' }}">
                                        <label for="nomor_akte_jual_beli" class="control-label require">Nomor Akta Jual Beli</label>
                                        <input id="nomor_akte_jual_beli" type="text" class="form-control " name="nomor_akte_jual_beli" value="{{ $per->getPembangunan->nomor_akte_jual_beli }}" >
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group{{ $errors->has('tanggal_akte_jual_beli') ? ' has-error' : '' }}">
                                        <label for="tanggal_akte_jual_beli" class="control-label require">Tanggal Pembuatan Sertifikat</label>
                                        <input type="text" class="form-control datepicker" data-provide="datepicker" data-date-today-highlight="true" data-date-format="yyyy-mm-dd" name="tanggal_akte_jual_beli" value="{{ $per->getPembangunan->tanggal_akte_jual_beli }}">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group{{ $errors->has('nama_notaris') ? ' has-error' : '' }}">
                                        ...
                                        <input id="nama_notaris" type="text" class="form-control " name="nama_notaris" value="{{ $per->getPembangunan->nama_notaris }}" >
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group{{ $errors->has('nama_ahli_waris') ? ' has-error' : '' }}">
                                        ...
                                        <input id="nama_ahli_waris" type="text" class="form-control " name="nama_ahli_waris" value="{{ $per->getPembangunan->nama_ahli_waris }}" >
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group{{ $errors->has('nomor_gs') ? ' has-error' : '' }}">
                                        <label for="nomor_gs" class="control-label require">Nomor GS</label>
                                        <input id="nomor_gs" type="text" class="form-control " name="nomor_gs" value="{{ $per->getPembangunan->nomor_gs }}" >
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group{{ $errors->has('tahun_gs') ? ' has-error' : '' }}">
                                        <label for="tahun_gs" class="control-label require">Tahun GS</label>
                                        <input id="tahun_gs" type="text" class="form-control " name="tahun_gs" value="{{ $per->getPembangunan->tahun_gs }}" >
                                    </div>
                                </div>
                                <div class='col-md-12'>
