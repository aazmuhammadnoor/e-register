                            ...
                            <div class='row'>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group{{ $errors->has('nomor_kendaraan') ? ' has-error' : '' }}">
                                        ...
                                        <input id="nomor_kendaraan" type="text" class="form-control " name="nomor_kendaraan" value="{{ $per->getTransportasi->nomor_kendaraan }}" >
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group{{ $errors->has('nomor_rangka') ? ' has-error' : '' }}">
                                        ...
                                        <input id="nomor_rangka" type="text" class="form-control " name="nomor_rangka" value="{{ $per->getTransportasi->nomor_rangka }}" >
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group{{ $errors->has('nomor_mesin') ? ' has-error' : '' }}">
                                        <label for="nomor_mesin" class="control-label require">Nomor Mesin</label>
                                        <input id="nomor_mesin" type="text" class="form-control " name="nomor_mesin" value="{{ $per->getTransportasi->nomor_mesin }}" >
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group{{ $errors->has('tahun_pembuatan') ? ' has-error' : '' }}">
                                        ...
                                        <input id="tahun_pembuatan" type="text" class="form-control " name="tahun_pembuatan" value="{{ $per->getTransportasi->tahun_pembuatan }}" >
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group{{ $errors->has('nama_pada_stnk') ? ' has-error' : '' }}">
                                        ...
                                        <input id="nama_pada_stnk" type="text" class="form-control " name="nama_pada_stnk" value="{{ $per->getTransportasi->nama_pada_stnk }}" >
                                    </div>
                                </div>
                                <div class='col-md-12'>
