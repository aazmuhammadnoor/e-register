                            ...
                            <div class='row'>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input id="no_pendaftaran_sementara" type="text" class="form-control " name="no_pendaftaran_sementara" value="{{ $per->no_pendaftaran_sementara }}" readonly style="background-color: #fcbaba">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group{{ $errors->has('kota_terbit') ? ' has-error' : '' }}">
                                        ...
                                        <select class="form-control" name="jenis_advertising" id="jenis_advertising" required>
                                            <option value="PERORANGAN (PO)" {{ $per->getReklame->jenis_advertising == 'PERORANGAN (PO)' ? "selected" : "" }} >PERORANGAN (PO)</option>
                                            <option value="FIRMA (FA)" {{ $per->getReklame->jenis_advertising == 'FIRMA (FA)' ? "selected" : "" }} >FIRMA (FA)</option>
                                            <option value="KOPERASI (KOP)" {{ $per->getReklame->jenis_advertising == 'KOPERASI (KOP)' ? "selected" : "" }} >KOPERASI (KOP)</option>
                                            <option value="COMMANDITAIRE VENNOOTSCHAP (CV)" {{ $per->getReklame->jenis_advertising == 'COMMANDITAIRE VENNOOTSCHAP (CV)' ? "selected" : "" }} >COMMANDITAIRE VENNOOTSCHAP (CV)</option>
                                            <option value="PERSEORAN TERBATAS (PT)" {{ $per->getReklame->jenis_advertising == 'PERSEORAN TERBATAS (PT)'  ? "selected" : "" }} >PERSEORAN TERBATAS (PT)</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-9">
                                    <div class="form-group{{ $errors->has('nama_perusahaan') ? ' has-error' : '' }}">
                                        ...
                                        <input id="nama_perusahaan" type="text" class="form-control " name="nama_perusahaan" value="{{ $per->getReklame->nama_perusahaan }}" >
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="provinsi" class="control-label require">Provinsi</label>
                                        <select class="form-control " name="provinsi_reklame" id="provinsi_reklame">
                                            @foreach($provinsi as $prov)
                                                <option value="{{ $prov->id }}" {{ $per->getReklame->provinsi == $prov->id ? "selected" : ""}}>{{ $prov->name }}</option>
                                            @endforeach
                                        </select> 
                                        @if ($errors->has('provinsi'))
                                            <span class="help-block">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="kabupaten" class="control-label require">Kabupaten</label>
                                        <select class="form-control " name="kabupaten_reklame" id="kabupaten_reklame"></select>
                                        @if ($errors->has('kabupaten'))
                                            <span class="help-block">
                                                <strong>{{ $errors->first('kabupaten') }}</strong>
                                            </span>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="kecamatan" class="control-label require">Kecamatan</label>
                                        <select class="form-control " name="kecamatan_reklame" id="kecamatan_reklame"></select>
                                        @if ($errors->has('kecamatan'))
                                            <span class="help-block">
                                                <strong>{{ $errors->first('kecamatan') }}</strong>
                                            </span>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="kelurahan" class="control-label require">Kelurahan</label>
                                        <select class="form-control " name="kelurahan_reklame" id="kelurahan_reklame"></select>
                                        @if ($errors->has('kelurahan'))
                                            <span class="help-block">
                                                <strong>{{ $errors->first('kelurahan') }}</strong>
                                            </span>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group{{ $errors->has('npwp') ? ' has-error' : '' }}">
                                        ...
                                        <input id="npwp" type="text" class="form-control " name="npwp" value="{{ $per->getReklame->npwp }}" >
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group{{ $errors->has('npwp_d') ? ' has-error' : '' }}">
                                        <label for="npwp_d" class="control-label require">NPWP Daerah</label>
                                        <input id="npwp_d" type="text" class="form-control " name="npwp_d" value="{{ $per->getReklame->npwp_d }}" >
                                    </div>
                                </div>
                                <div class="col-md-2">
                                    <div class="form-group">
                                        <label for="rw" class="control-label require">RW</label>
                                        <input id="rw_reklame" type="text" class="form-control " name="rw_reklame" value="{{ $pendaftar != null ? $per->getReklame->rw : '' }}" >
                                    </div>
                                </div>
                                <div class="col-md-2">
                                    <div class="form-group">
                                        <label for="rt" class="control-label require">RT</label>
                                        <input id="rt_reklame" type="text" class="form-control " name="rt_reklame" value="{{ $pendaftar != null ? $per->getReklame->rt : '' }}" >
                                    </div>
                                </div>
                                <div class="col-md-2">
                                    <div class="form-group">
                                        <label for="kode_pos" class="control-label require">Kode Pos</label>
                                        <input id="kode_pos_reklame" type="text" class="form-control " name="kode_pos_reklame" value="{{ $pendaftar != null ? $per->getReklame->kode_pos : '' }}" >
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="alamat" class="control-label require">Alamat</label>
                                        <textarea class="form-control " name="alamat_reklame" >{{ $pendaftar != null ? $per->getReklame->alamat : '' }}</textarea>
                                    </div>
                                </div>
                                <div class='col-md-12'>
...
@section('js')
    ...
    <script>
        ...
        //$('.numeric').autoNumeric();
        getKabupatenReklame($("#provinsi_reklame").val());

        $(document).on("change","#provinsi_reklame",function(e){
            getKabupatenReklame($(this).val());
        });

        $(document).on("change","#kabupaten_reklame",function(e){
            getKecamatanReklame($(this).val());
        });

        $(document).on("change","#kecamatan_reklame",function(e){
            getKelurahanReklame($(this).val());
        });

        function getKabupatenReklame(provinsi)
        {
            $.ajax({
                type :'get',
                url  :'{{ url('wilayah/kab_by_prov') }}/'+provinsi+'/getAjax',
                success:function(xhr){
                    option = ``;
                    kabupaten = '{{ $per->getReklame->kabupaten }}';
                    $.each(xhr,function(d,i){
                        selected = (kabupaten == i.id) ? "selected" : "";
                        option += `<option value="${i.id}" ${selected}>${i.name}</option>`;
                    })
                    $("#kabupaten_reklame").html(option);
                    getKecamatanReklame($("#kabupaten_reklame").val());
                }
            });
        }

        function getKecamatanReklame(kabupaten)
        {
            $.ajax({
                type :'get',
                url  :'{{ url('wilayah/kec_by_kab') }}/'+kabupaten+'/getAjax',
                success:function(xhr){
                    option = ``;
                    kecamatan = '{{ $per->getReklame->kecamatan }}';
                    $.each(xhr,function(d,i){
                        selected = (kecamatan == i.id) ? "selected" : "";
                        option += `<option value="${i.id}" ${selected}>${i.name}</option>`;
                    })
                    $("#kecamatan_reklame").html(option);
                    getKelurahanReklame($("#kecamatan_reklame").val());
                }
            });
        }

        function getKelurahanReklame(kecamatan)
        {
            $.ajax({
                type :'get',
                url  :'{{ url('wilayah/kel_by_kec') }}/'+kecamatan+'/getAjax',
                success:function(xhr){
                    option = ``;
                    kelurahan = '{{ $per->getReklame->kelurahan }}';
                    $.each(xhr,function(d,i){
                        selected = (kelurahan == i.id) ? "selected" : "";
                        option += `<option value="${i.id}" ${selected}>${i.name}</option>`;
                    })
                    $("#kelurahan_reklame").html(option);
                    $("#kelurahan_reklame").val('{{ $per->getReklame->kelurahan }}');
                }
            });
        }
