...
<main>
    <div class="main-content">
        <ol class="breadcrumb breadcrumb-arrow">
            ...
            <li class="breadcrumb-item"><a href="{{ url('admin/proses/info-korlap-bap') }}">Inbox Permohonan Rekomendasi Teknis</a></li>
    								...
    								<tr class="{{ ($row->getWorkflowStatus->getSubtask()->latest()->first()->event != 'mulai') ? "bl-3 border-success" : "bl-3 border-danger bg-pale-warning" }}">
                                        ...
                                        <td class="text-center table-actions">
                                            ...
                                            <a href="#" class="table-action hover-primary"
                                                data-url="{{ url('admin/proses/info-korlap-bap/view',[$row->id]) }}"
