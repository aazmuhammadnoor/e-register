<div class="flexbox mb-20">
	...
	<div class="btn-toolbar">
		<div class="btn-group btn-group-sm">
			<!--
			<button class="btn" title="" data-provide="tooltip"  data-url="{{ url('admin/proses/kadin/filter') }}" data-type="right" data-original-title="Filter" data-title="Filter Data Permohonan" id="modal-filter"><i class="ti-filter"></i> Filter</button>-->
			<button onclick="javascript:window.location.href='{{ url('admin/proses/kadin/list',[$kat->id]) }}'" class="btn" title="" data-provide="tooltip" data-original-title="Refresh"><i class="ion-refresh"></i> Refresh</button>
		</div>
	</div>
</div>
...
$('#search').keypress(function (e) {
  ...
  {
    var value = $(this).val();
    window.location.href= "{{ url('admin/proses/kadin/search') }}/"+value+"";
  }
});
