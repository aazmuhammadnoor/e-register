    		...
    		<div class="col-12">
    			<div class="card">
    				...
    				<div class="card-body">
    					...
    					@include('admin.proses.tim-teknis.toolbar')
                        {!! Form::open(['url'=>'admin/proses/tim-teknis/list/'.$kat->id,'method'=>'get','class'=>'form-inline pull-right']) !!}
    							...
    							<tbody>
    								...
    								<tr class="{{ ($row->getWorkflowStatus->getSubtask()->latest()->first()->event != 'mulai') ? "bl-3 border-success" : "bl-3 border-danger bg-pale-warning" }}">
                                        ...
                                        <td class="text-center table-actions">
                                            ...
                                            <a href="{{ url('admin/proses/tim-teknis/edit',[$row->id]) }}"
                                                class="table-action hover-danger p-2 text-white btn btn-primary"
                                                data-provide="tooltip" data-original-title="Periksa">
                                                <i class="ti-files"></i>
                                            </a>

                                            @if($row->tgl_survey != null)
                                            {{-- <a href="#!"
                                                class="table-action hover-primary"
                                                data-provide="tooltip" data-original-title="Download Rekomendasi Survey">
                                                <i class="ti-download"></i>
                                            </a> --}}
                                            <a href="{{ url('admin/proses/tim-teknis/hasil_survey',[$row->id]) }}"
                                                class="table-action hover-warning p-2 text-white btn btn-info"
                                                data-provide="tooltip" data-original-title="Hasil Survey">
