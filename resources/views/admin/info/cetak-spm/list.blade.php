    		...
    		<div class="col-12">
    			<div class="card">
    				...
    				<div class="card-body">
    					...
    					@include('admin.proses.cetak-spm.toolbar')
                         {!! Form::open(['url'=>'admin/proses/cetak-spm/list/'.$kat->id,'method'=>'get','class'=>'form-inline pull-right']) !!}
    							...
    							<tbody>
    								...
    								<tr class="{{ ($row->getWorkflowStatus->getSubtask()->latest()->first()->event != 'mulai') ? "bl-3 border-success" : "bl-3 border-danger bg-pale-warning" }}">
                                        ...
                                        <td class="text-center table-actions">
                                            ...
                                            <a href="{{ url('admin/proses/cetak-spm/edit',[$row->id]) }}"
                                                class="table-action hover-danger btn btn-primary text-white p-1"
                                                data-provide="tooltip" data-original-title="Input Data SPM">
