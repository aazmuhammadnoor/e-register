                        ...
                        <div class="row">
                            <div class="col-12">
                                {!! Form::open(['url'=> url()->current() ,'method'=>'post','class'=>'form-inline pull-right']) !!}
                                    @include('admin.info.partial.search_info')
                                {!! Form::close() !!}
                            </div>
                        </div>
    						...
    						<table class="table table-sm table-striped table-hover small" data-provide="selectall selectable">
    							<thead class="thead-default">
    								<tr>
                                        ...
                                        <th width="120">Tanggal Permohonan</th>
    							...
    							<tbody>
    								...
    								<tr>
                                        ...
                                        <td>
                                            ...
                                            {{ text_status_permohonan($row->getWorkflowStatus->getSubtask()->latest()->first()->sub_task,$row->posisi) }}
                                        </td>
