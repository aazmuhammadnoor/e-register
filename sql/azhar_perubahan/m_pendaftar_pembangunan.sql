...
-- ----------------------------
-- Table structure for m_pendaftar_pembangunan
-- ----------------------------
DROP TABLE IF EXISTS `m_pendaftar_pembangunan`;
CREATE TABLE `m_pendaftar_pembangunan`  (
  ...
  `nama_pada_sertifikat` varchar(150) CHARACTER SET latin1 COLLATE latin1_swedish_ci NULL DEFAULT NULL,
  ...
  CONSTRAINT `m_pendaftar_pembangunan_ibfk_1` FOREIGN KEY (`id_pendaftar`) REFERENCES `m_pendaftar` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
